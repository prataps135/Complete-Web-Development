...
const yourAPIKey = "3e2b36f4-abcf-4605-bf66-6fa9f756bdcc";
const yourBearerToken = "19ce7e44-5e9c-4fa3-83ea-ae747dcd1d8e";
  ...
  */
  ...
  try {
    const response = await axios(
      "https://secrets-api.appbrewery.com/user-secrets",
      {
        headers: {
